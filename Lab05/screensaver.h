...
private:
    sf::CircleShape shape;
public:
    ClassicSaver(float radius, sf::Vector2f cVelocity, sf::Color color);
...
class ColorChangingSaver : public ScreenSaver {
private:
    sf::CircleShape shape;
    float colorSpeed;
public:
    ColorChangingSaver(float radius, sf::Vector2f cVelocity, float cColorSpeed);
    void update(float deltaTime, int screenWidth, int screenHeight);
};
...
private:
    ...
    float spinSpeed;
public:
    CustomSaver(float sideLength, sf::Vector2f cVelocity, float cSpinSpeed);
    void update(float deltaTime, int screenWidth, int screenHeight);
};
